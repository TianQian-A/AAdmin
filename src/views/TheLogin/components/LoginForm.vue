...
<template>
	<el-form ref="loginFormRef" :model="loginRulesPassword" :rules="loginRulesPassword">
		<el-form-item prop="username">
			<el-input v-model="loginFormPassword.account" :disabled="onLogin" placeholder="输入账号" :prefix-icon="User" />
		</el-form-item>
		...
		<el-button class="w-full" type="primary" round :loading="onLogin" @click="submit">立即登录</el-button>
	</el-form>
</template>
